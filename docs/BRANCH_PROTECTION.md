...
10. Enable the dependency graph and Dependabot alerts/security updates. Gitleaks provides
    the pipeline's secret scanning without requiring GitHub Secret Protection.
